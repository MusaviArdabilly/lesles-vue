<template>
  <div class="space-y-6">
    ...
    <div class="flex min-h-[calc(100dvh_-_84px)] h-full items-center">
      ...
      <div
        v-if="loading"
        class="w-full rounded-lg bg-white border border-gray-300 p-4 animate-pulse space-y-3 animate-pulse"
      >
        <div
      ...
      <div v-if="classData">
        ...
        <div class="rounded-lg bg-white border border-gray-300 p-4">
          ...
          <div
            v-for="(attendances, date) in classData.attendances_grouped"
            :key="date"
